    ...
    <>
      ...
      <section className="max-w-[1280px] mx-auto py-16 px-6 max-sm:py-10 max-sm:px-4">
        <div className="mb-8 max-sm:mb-6">
          <div>
            <h1 className="font-display text-4xl font-bold text-primary mb-2 max-sm:text-3xl">Hot Sales</h1>
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-2.5 mt-auto">
                  ...
                  <button
                    className="flex-1 border-none bg-primary text-white py-3 rounded-lg cursor-pointer text-sm font-semibold hover:bg-primary-dark"
                    onClick={() =>
