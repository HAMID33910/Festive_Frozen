    ...
    <div className="flex min-h-screen max-[768px]:flex-col">
      <div className="flex-1 relative bg-[url('/src/assets/frozen.png')] bg-cover bg-center hidden md:flex items-center p-12">
        ...
        <div className="relative z-10 text-white max-w-lg">
          ...
          <h1 className="font-display text-5xl font-bold mb-4 max-[900px]:text-4xl">Join FreshRewards</h1>
          ...
          <ul className="list-none p-0 mt-6 space-y-3">
            <li className="flex items-center gap-3 text-white/80 text-sm"><span className="material-symbols-outlined">ac_unit</span>Flash-frozen, chef-approved quality</li>
            <li className="flex items-center gap-3 text-white/80 text-sm"><span className="material-symbols-outlined">local_shipping</span>48-hour cold-chain delivery</li>
            <li className="flex items-center gap-3 text-white/80 text-sm"><span className="material-symbols-outlined">verified</span>Exclusive discounts on every order</li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-start justify-start pt-12 p-10 max-[768px]:items-center max-[768px]:justify-center max-[768px]:pt-0 max-[768px]:p-6 max-[480px]:p-4 max-[768px]:overflow-y-auto">
        <div className="w-full max-w-[520px]">
          ...
          <p className="text-on-surface-variant text-sm mb-6">
            Already have one? <Link to="/LoginScreen" className="text-primary font-semibold no-underline hover:underline">Log in</Link>
          </p>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit} noValidate>
            <div className="grid grid-cols-2 gap-4 max-[600px]:grid-cols-1">
              <div className="flex flex-col mb-1">
                ...
                />
                {errors.firstName && <span className="text-error-light text-xs mt-1">{errors.firstName}</span>}
              </div>
              ...
              <div className="flex flex-col mb-1">
                ...
                />
                {errors.lastName && <span className="text-error-light text-xs mt-1">{errors.lastName}</span>}
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 max-[600px]:grid-cols-1">
            ...
            <div className="flex flex-col mb-1">
              ...
              />
              {errors.phone && <span className="text-error-light text-xs mt-1">{errors.phone}</span>}
            </div>
            ...
            <div className="flex flex-col mb-1">
              ...
              {errors.confirmPassword && (
                <span className="text-error-light text-xs mt-1">{errors.confirmPassword}</span>
              )}
            </div>
            </div>
            ...
            <div className="flex flex-col mb-1">
              ...
              {errors.agree && <span className="text-error-light text-xs mt-1">{errors.agree}</span>}
            </div>
